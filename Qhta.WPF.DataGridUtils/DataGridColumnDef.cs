...
using Visibility = Qhta.MVVM.Visibility;

namespace Qhta.WPF.DataGridUtils;

/// <summary>
/// This data contains full <see cref="DataGridContentBoundColumn"/> definition.
/// </summary>
public class DataGridColumnDef
{
  /// <summary>
  /// Initializing constructor.
  /// </summary>
  /// <param name="binding"></param>
  public DataGridColumnDef(BindingBase binding)
  {
    Binding = binding;
  }
