    ...
    if (itemsControl != null)
    {
      ...
      if (prop != null)
      {
        ...
        if (dataGridColumnAttr != null && dataGridColumnAttr.IsAutoGenerated)
        {
          ...
          if (binding != null)
          {
            if (dataGridColumnAttr.UpdateImmediately)
            ...
            if (dataGridColumnAttr.CheckImmediately && column is DataGridCheckBoxColumn && !column.IsReadOnly)
            {
              var checkboxFactory = new FrameworkElementFactory(typeof(CheckBox));
              checkboxFactory.SetValue(FrameworkElement.HorizontalAlignmentProperty, HorizontalAlignment.Center);
              checkboxFactory.SetValue(FrameworkElement.VerticalAlignmentProperty, VerticalAlignment.Center);
              checkboxFactory.SetBinding(ToggleButton.IsCheckedProperty, new Binding(args.PropertyName) 
              { UpdateSourceTrigger = UpdateSourceTrigger.PropertyChanged });

              column = args.Column = new DataGridTemplateColumn
              {
