...
public class DynamicTemplateSelector : DataTemplateSelector
{
  ...
  public override System.Windows.DataTemplate SelectTemplate(object item, System.Windows.DependencyObject container)
  {
    ...
    if (container is UIElement uiElement)
    {
      ...
      TemplateCollection? templates = GetTemplates(uiElement);
      ...
      if (templates != null)
        ...
        foreach (var template in templates)
          ...
          if (template.DataType.IsInstanceOfType(item))
...
public class Template : DependencyObject
{
  ...
  /// <summary>
  /// Provides the <see cref="DataTemplate"/> used to render items matching the <see cref="DataType"/>
  /// </summary>
  ...
  /// <summary>
  /// Gets or Sets the <see cref="DataTemplate"/> used to render items matching the <see cref="DataType"/>
  /// </summary>
