...
EndSelection:<<<<<<<<4";
  ...
  public static DataObject CreateHtmlDataObject(string html, string plainText)
  {
  ...
  /// See <see  cref="CreateHtmlDataObject"/> for HTML fragment details.<br/>      
  /// </summary>      
  /// <example>      
  ...
  {
    var dataObject = CreateHtmlDataObject(html, plainText);
