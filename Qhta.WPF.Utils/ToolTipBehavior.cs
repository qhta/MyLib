...
public class ToolTipBehavior
{
  ...
  private static void ActiveToolTipEnabledChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
  {
  ...
  private static Popup ToolTipPopup = new Popup { /*Placement = PlacementMode.Bottom*/ };
