...
/// <summary>
/// Defines implementation methods for DataGrid filtering
/// </summary>
public static class DataGridBehavior
{
  ...
  public static void FilterButton_Click(object sender, RoutedEventArgs args)
  {
            ...
            if (column != null)
            {
              if (column.TryGetFilterablePropertyPath(itemType, out var propPath))
              {
                ...
                if (propertyInfo != null)
                {
                  ...
                  if (ok)
                  {
                    var viewModel = DataGridBehavior.GetColumnFilter(column) as FilterViewModel;
                    if (viewModel != null)
                    {
                      var filter = viewModel.CreateFilter();
                      CollectionViewBehavior.SetFilterButtonShape(column, filter != null ? FilterButtonShape.Filled : FilterButtonShape.Empty);
  ...
  public static bool DisplayFilterDialog(ItemsControl itemsControl, DataGridColumn column, PropPath propPath, Point position, Window? ownerWindow)
  {
  ...
  /// </summary>
  public static FilterableColumns? GetFilterableColumns(DataGrid dataGrid)
  {
