...
public interface IXSerializer
{
  ...
  ///   XML element name to place before each property name
  ///   when <see cref="SerializationOptions.PrecedePropertyNameWithClassName" /> is set
  /// </param>
  ...
  /// <param name="elementTag">
  ///   XML element name to place before collection tag
  ///   when <see cref="SerializationOptions.PrecedePropertyNameWithClassName" /> is set
  /// </param>
  ...
  int WriteCollectionBase(IXWriter writer, string? elementTag, string? collectionTag, ICollection collection,
    KnownItemTypesCollection? itemTypes = null);
