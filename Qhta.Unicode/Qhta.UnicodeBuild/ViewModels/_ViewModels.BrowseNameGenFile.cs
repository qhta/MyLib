...
public partial class _ViewModels
{
  ...
  /// </summary>
  public RelayCommand<WritingSystemViewModel>? BrowseNameGenFileCommand { [DebuggerStepThrough] get; set; }

  private void BrowseNameGenFileCommandExecute(WritingSystemViewModel? writingSystem)
  {
