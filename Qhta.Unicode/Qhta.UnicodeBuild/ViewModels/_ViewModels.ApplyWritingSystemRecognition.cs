...
{
  private void InitializeApplyWritingSystemRecognition()
  {
    ApplyWritingSystemRecognitionCommand = new RelayCommand<object>(ApplyWritingSystemRecognitionCommandExecute);
    ApplyWritingSystemRecognitionBackgroundWorker.DoWork += ApplyWritingSystemRecognition_DoWork;
    ApplyWritingSystemRecognitionBackgroundWorker.ProgressChanged += ApplyWritingSystemRecognition_ProgressChanged;
    ApplyWritingSystemRecognitionBackgroundWorker.RunWorkerCompleted += ApplyWritingSystemRecognition_RunWorkerCompleted;
  ...
  /// </summary>
  public RelayCommand<object>? ApplyWritingSystemRecognitionCommand { [DebuggerStepThrough] get; set; }

  private void ApplyWritingSystemRecognitionCommandExecute(object? argument)
  {
    if (ApplyWritingSystemRecognitionBackgroundWorker.IsBusy) return;
  ...
  private void ApplyWritingSystemRecognition_ProgressChanged(object? sender, ProgressChangedEventArgs e)
  {
  ...
  private void InitWritingSystemCategoryPhraseMap()
  {
    ...
    foreach (var writingSystem in WritingSystems.Where(item => item.Ctg != null && !item.Ctg.Contains('*')))
    ...
    foreach (var writingSystem in WritingSystems.Where(item => item.Ctg == null))
      AddWritingSystemCategoryPhraseMap(writingSystem);
  }
  ...
  /// </summary>
  public IRelayCommand? BreakApplyWritingSystemRecognitionCommand { [DebuggerStepThrough] get; set; }

  /// <summary>
  /// Executes the command to break the apply writing system mapping operation.
  /// </summary>
  public void BreakApplyWritingSystemRecognitionCommandExecute()
  {
    if (ApplyWritingSystemRecognitionBackgroundWorker.IsBusy)
    {
      ApplyWritingSystemRecognitionBackgroundWorker.CancelAsync();
    }
  }
  ...
  /// </summary>
  public BackgroundWorker ApplyWritingSystemRecognitionBackgroundWorker = new BackgroundWorker
  {
  ...
  private void ApplyWritingSystemRecognition_RunWorkerCompleted(object? sender, RunWorkerCompletedEventArgs e)
  {
