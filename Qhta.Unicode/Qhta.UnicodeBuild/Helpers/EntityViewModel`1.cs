  ...
  where T : class, new()
{
  ...
  /// <param name="thisPropertyName">The name of the property to change. Must be a valid property name of the current instance's type.</param>
  /// <param name="modelPropertyName">The name of the model property to change. Must be a valid property name of the model instance's type.</param>
