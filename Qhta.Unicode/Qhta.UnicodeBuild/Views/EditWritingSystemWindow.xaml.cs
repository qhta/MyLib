...
public partial class EditWritingSystemWindow : Window
{
  ...
  public bool AddMode
  {
    [DebuggerStepThrough] get => (bool)GetValue(AddModeProperty);
  ...
  /// </summary>
  public RelayCommand<WritingSystemViewModel> OkCommand { [DebuggerStepThrough] get; }
  ...
  private void SaveData(WritingSystemViewModel? newItem)
  {
    ...
    else
    {
      ...
      _ViewModels.Instance.DbContext.SaveChanges(); // Save changes to the database is mandatory as the Id is generated by the database
  ...
  /// </summary>
  public ICommand CancelCommand { [DebuggerStepThrough] get; }
