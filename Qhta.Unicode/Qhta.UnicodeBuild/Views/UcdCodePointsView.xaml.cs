...
public partial class UcdCodePointsView : UserControl, IRoutedCommandHandler
{
  ...
  private void CodePointDataGrid_OnFilterItemsPopulating(object? sender, GridFilterItemsPopulatingEventArgs e) => SfDataGridFilterTools.FilterItemsPopulating(sender, e);

  private void CodePointDataGrid_OnFilterChanging(object? sender, GridFilterEventArgs e) => SfDataGridFilterTools.FilterChanging(sender, e);
