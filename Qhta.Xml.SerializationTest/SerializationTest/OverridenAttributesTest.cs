...
namespace College
{
  ...
  public static class OverridenAttributesTest
  {
    public static void Run()
    {
      WriteOverriddenAttributes("College.xml");
      ReadOverriddenAttributes("College.xml");
    }

    private static void WriteOverriddenAttributes(string filename)
    {
    ...
    private static void ReadOverriddenAttributes(string filename)
    {
