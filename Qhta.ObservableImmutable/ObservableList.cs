...
namespace Qhta.ObservableImmutable
{
    ...
    INotifyCollectionChanged, INotifyPropertyChanged
  {
    ...
    public bool TryOperation(Func<List<T>, List<T>> operation)
    {
      return TryOperation(operation, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool DoOperation(Func<List<T>, List<T>> operation)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool TryOperation(Func<List<T>, List<T>> operation, NotifyCollectionChangedEventArgs args)
    {
      try
      {
        if (Helper.TryLock())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool TryOperation(Func<List<T>, KeyValuePair<List<T>, NotifyCollectionChangedEventArgs>> operation)
    {
      try
      {
        if (Helper.TryLock())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool DoOperation(Func<List<T>, List<T>> operation, NotifyCollectionChangedEventArgs args)
    {
      bool result;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool DoOperation(Func<List<T>, KeyValuePair<List<T>, NotifyCollectionChangedEventArgs>> operation)
    {
      bool result;
    ...
    //public bool DoInsert(Func<List<T>, KeyValuePair<int, T>> valueProvider)
    //{
    //  return DoOperation
    //    (
    //    currentItems =>
    ...
    //      currentItems.Insert(kvp.Key, kvp.Value);
    ...
    public void Insert(int index, T element)
    {
      ...
      NotifyCollectionChanged(NotifyCollectionChangedAction.Add, element, index);
    }
