...
namespace Qhta.ObservableImmutable
{
    ...
    INotifyCollectionChanged, INotifyPropertyChanged
    {
      ...
      protected ImmutableList<T> _items = ImmutableList<T>.Empty;
      ...
      public IImmutableList<T> Insert(int index, T element)
      {
        ...
        NotifyCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add, element, index));
        return this;
      }
