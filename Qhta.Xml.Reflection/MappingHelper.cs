...
public static class MappingHelper
{
  ...
  /// <param name="nameCase">Mode as enumerated by <see cref="NameCase"/> type.</param>
  /// <returns>String with changed case</returns>
  public static string ChangeCase(this string str, NameCase nameCase)
  {
    switch (nameCase)
    {
      case NameCase.LowercaseFirstLetter:
        return FirstLetterToLower(str);
      case NameCase.UppercaseFirstLetter:
