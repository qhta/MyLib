...
namespace Qhta.WPF.PropertyGrid
{
  public class PropertiesCollection : ObservableCollection<IPropertyViewModel>
  {
    ...
    IPropertyViewModel activeProperty = null;
    /// <summary>
    /// The active, or selected, property.
    /// </summary>
    public IPropertyViewModel ActiveProperty
    {
      get => activeProperty;
      set
      {
        activeProperty = value;
        OnPropertyChanged(new PropertyChangedEventArgs("ActiveProperty"));
      }
    }

    IPropertyViewModel featured = null;
    /// <summary>
    /// Gets the featured property, which is placed above all others.
    /// </summary>
    public IPropertyViewModel Featured
    {
      get => featured;
      private set
      {
        featured = value;
        OnPropertyChanged(new PropertyChangedEventArgs("Featured"));
      }
    }
    ...
    /// 
    /// </summary>
    public PropertiesCollection() : base()
    {
    }
    ...
    bool IsSupported(PropertyInfo Property)
    {
      ...
      var b = t.IsEnum;
      //b = b ||t.EqualsAny(IPropertyViewModel.Selector.Types);
    ...
    //        {
    //          var Model = IPropertyViewModel.Selector.Select(source, Property, Attributes, propertyType);
    ...
    {
      Featured = default(IPropertyViewModel);
      Source = source;
      Clear();
    }
