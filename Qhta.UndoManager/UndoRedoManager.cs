...
public static class UndoRedoManager
{
  ...
  /// </summary>
  public static bool IsEnabled { [DebuggerStepThrough] get; set; } = true;

  /// <summary>
  /// Flag to indicate that the manager is currently undoing an action.
  /// </summary>
  public static bool IsUndoing { [DebuggerStepThrough] get; set; } = false;

  /// <summary>
  /// Flag to indicate that the manager is currently redoing an action.
  /// </summary>
  public static bool IsRedoing { [DebuggerStepThrough] get; set; } = false;

  /// <summary>
  /// Flag to indicate that the manager is currently recording an action.
  /// </summary>
  public static bool IsRecording { [DebuggerStepThrough] get; set; } = false;

  /// <summary>
  /// Flag to indicate that the manager is currently grouping actions.
  /// </summary>
  public static bool IsGrouping { [DebuggerStepThrough] get; set; } = false;

  /// <summary>
  /// Flag to indicate that the Undo functionality is available.
  /// </summary>
  public static bool IsUndoAvailable => UndoStack.Any() && !IsUndoing && !IsRedoing && !IsRecording;

  /// <summary>
  /// Flag to indicate that the Redo functionality is available.
  /// </summary>
  public static bool IsRedoAvailable => RedoStack.Any() && !IsUndoing && !IsRedoing && !IsRecording;

  /// <summary>
  /// Flag to indicate that the recording is available.
  /// </summary>
  public static bool IsRecordingAvailable => !IsUndoing && !IsRecording;

  /// <summary>
  /// Flag to indicate that the grouping is available.
  /// </summary>
  ...
  {
    if (!IsEnabled || !IsRecordingAvailable)
      return;
    if (IsGrouping)
    {
  ...
  {
    if (!IsEnabled || !IsGroupingAvailable)
      return;
    IsGrouping = true;
