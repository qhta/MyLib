...
/// </summary>
public class SfDataGridColumnCreator
{
  /// <summary>
  /// Initializing contructor
  /// </summary>
  public SfDataGridColumnCreator(Control dataGrid, Type sourceItemsType, Type itemType)
  {
    _Control = dataGrid;
        ...
        if (dataGridColumnAttr != null && dataGridColumnAttr.IsAutoGenerated)
        {
          ...
          if (binding != null)
          {
            var dataGridColumnDef = new DataGridColumnDef(binding)
            {
              ...
              Visibility = (System.Windows.Visibility)dataGridColumnAttr.Visibility,
