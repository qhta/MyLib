...
public static partial class StylesTools
{
  ...
  private static readonly Dictionary<BuiltinStyles, (StyleType Type, string Ident, string Name)> KnownStyles = new ()
    ...
    { OpenXmlTools.BuiltinStyles.BodyTextIndent, (StyleType.Paragraph, "BodyTextIndent", "Body Text IndentUnit") },
    { OpenXmlTools.BuiltinStyles.BodyTextIndentChar, (StyleType.Linked, "BodyTextIndentChar", "Body Text IndentUnit Char") },
    ...
    { OpenXmlTools.BuiltinStyles.BodyTextFirstIndent, (StyleType.Paragraph, "BodyTextFirstIndent", "Body Text First IndentUnit") },
    { OpenXmlTools.BuiltinStyles.BodyTextFirstIndentChar, (StyleType.Linked, "BodyTextFirstIndentChar", "Body Text First IndentUnit Char") },
    { OpenXmlTools.BuiltinStyles.BodyTextFirstIndent2, (StyleType.Paragraph, "BodyTextFirstIndent2", "Body Text First IndentUnit 2") },
    { OpenXmlTools.BuiltinStyles.BodyTextFirstIndent2Char, (StyleType.Linked, "BodyTextFirstIndent2Char", "Body Text First IndentUnit 2 Char") },
    ...
    { OpenXmlTools.BuiltinStyles.BodyTextIndent2, (StyleType.Paragraph, "BodyTextIndent2", "Body Text IndentUnit 2") },
    { OpenXmlTools.BuiltinStyles.BodyTextIndent2Char, (StyleType.Linked, "BodyTextIndent2Char", "Body Text IndentUnit 2 Char") },
    { OpenXmlTools.BuiltinStyles.BodyTextIndent3, (StyleType.Paragraph, "BodyTextIndent3", "Body Text IndentUnit 3") },
    { OpenXmlTools.BuiltinStyles.BodyTextIndent3Char, (StyleType.Linked, "BodyTextIndent3Char", "Body Text IndentUnit 3 Char") },
